...
from FinalExam.app_auth.forms import CustomLoginForm
from FinalExam.app_auth.views import SignUpView, LogOutView, SignUpUser, SignUpRecruiter, profile_description, \
...
urlpatterns = [
    ...
    path('<int:pk>/delete/', profile_delete, name='delete-profile' ),
