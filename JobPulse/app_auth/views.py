...
from JobPulse.app_auth.forms import SignUpUserForm, SignUpRecruiterForm, EditUserForm, EditModeratorForm, \
    EditUserProfileForm
from JobPulse.app_auth.models import UserProfile, Recruiters, Moderators
